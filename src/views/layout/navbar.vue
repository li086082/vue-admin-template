...
<template>
    <nav class="nav">
        <header class="head" v-if="app.showLogo">
            {{ app.title }}
        </header>
        <el-scrollbar>
            <el-menu default-active="2" :show-timeout="0" :hide-timeout="0">
                <el-sub-menu index="2">
                    <template #title>p item one</template>
                ...
                <el-sub-menu index="1-4">
                    <template #title>p item two</template>
